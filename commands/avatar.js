...
module.exports = {
  ...
  async execute(interaction) {
    try {
      //Trying to create an embed with user's avatar
      ...
      //Returns an error message if error (Probably target user has no avatar)
      console.error(err)
      await interaction.reply({
        embeds: [
          {
            author: {
              name: 'Отакої! Виникла помилка, скоріше за все в учасника не встановлений аватар',
            },
            color: 0xcc2929,
          },
        ],
