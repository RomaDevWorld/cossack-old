  ...
  async execute(interaction) {
    ...
    if (!vote) {
      ...
      return await interaction.reply({
        content: 'Це голосування більше не існує.',
        ephemeral: true,
      })
    }
    if (vote.author !== interaction.user.id)
      return await interaction.reply({
        content: 'Голосування можуть закривати лишень його творці.',
        ephemeral: true,
      })
    ...
    await interaction.reply({
      content: 'Голосування успішно закрито!',
      ephemeral: true,
    })
  },
}
